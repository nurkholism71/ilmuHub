    ...
    <section className="relative overflow-hidden bg-[#F6F0E7] border-b border-[#E8DFC8] min-h-[220px] sm:min-h-[250px] flex items-center">
      ...
      <div className="absolute inset-0 w-full h-full pointer-events-none select-none z-0 overflow-hidden">
        <img
          ...
          alt="Panoramic view of Cairo and student"
          className="w-full h-full object-cover object-[72%_30%] sm:object-[70%_35%] lg:object-[66%_38%] scale-105"
        />
        {/* Soft seamless gradient overlays */}
        <div className="absolute inset-0 bg-gradient-to-r from-[#F6F0E7] via-[#F6F0E7]/90 via-35% to-transparent lg:via-[#F6F0E7]/80 lg:via-28%"></div>
        <div className="absolute inset-0 bg-gradient-to-l from-[#F6F0E7]/40 via-transparent to-transparent"></div>
        <div className="absolute inset-0 bg-gradient-to-t from-[#F6F0E7]/70 via-transparent to-transparent"></div>
      </div>
      ...
      <div className="max-w-[1440px] mx-auto px-4 lg:px-8 py-8 sm:py-10 relative z-10 w-full">
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
          ...
          <div className="max-w-md lg:max-w-lg">
            ...
            <div className="font-arabic text-2xl sm:text-3xl font-bold text-gray-900 leading-relaxed mb-2">
              اكتشف العلم
            </div>

            <p className="text-xs sm:text-sm text-gray-600 leading-relaxed max-w-md font-medium">
              Temukan ribuan kelas dari tutor terbaik di Mesir. Belajar Nahwu, Sharaf, Bahasa Arab, studi Islam, dan berbagai mata kuliah universitas.
            </p>
          </div>

          {/* Top Right Calligraphy with clear, beautiful background & crisp shadow */}
