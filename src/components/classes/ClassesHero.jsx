        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
          ...
          <div className="max-w-xl">
            ...
            <div className="font-arabic text-2xl sm:text-3xl font-bold text-gray-900 leading-relaxed mb-2">
              ابحث عن الدرس المناسب لك
            </div>

            <p className="text-xs sm:text-sm text-gray-600 leading-relaxed max-w-lg font-medium">
              Ribuan kelas dari tutor berpengalaman di Mesir. Belajar Nahwu, Sharaf, Bahasa Arab, studi Islam, dan berbagai mata kuliah universitas.
            </p>
          </div>
