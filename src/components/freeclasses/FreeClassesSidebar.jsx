...
export default function FreeClassesSidebar({
  selectedSubjects,
  onToggleSubject,
  selectedLevels,
  onToggleLevel,
  ...
  const levelsList = [
    { id: 'Beginner', label: 'Beginner', count: 420 },
    { id: 'Intermediate', label: 'Intermediate', count: 380 },
    { id: 'Advanced', label: 'Advanced', count: 210 },
  ];

  const classTypesList = [
    { id: 'Live Class', label: 'Live Class', count: 320 },
    { id: 'Recorded Class', label: 'Recorded Class', count: 720 },
    { id: 'Hybrid', label: 'Hybrid', count: 140 },
  ];
